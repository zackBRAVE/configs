...
noremap sl :set nosplitbelow<CR>:split<CR>:set splitbelow<CR>
noremap sk :set splitbelow<CR>:split<CR>
noremap sj :set nosplitright<CR>:vsplit<CR>:set splitright<CR>
noremap s; :set splitright<CR>:vsplit<CR>
...
augroup calendar-mappings
	...
	autocmd FileType calendar nmap <buffer> <c-l> <Plug>(calendar_move_up)
	...
	autocmd FileType calendar nmap <buffer> <c-;> <Plug>(calendar_move_right)
